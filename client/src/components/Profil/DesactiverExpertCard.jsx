...
import "../../componentsStyles/ProfilStyles/DesactiverExpertCard.css";

const DesactiverExpert = ({ name, lastName, email, phone, expertise, Etablissement, Discipline, Centre , Dossier }) => {
  return (
