...
const ProjetsInfos2 = ({id})  => { 
  
  const navigate = useNavigate();
  return (       
    <div className="InfosPros2-container2">
      <div className="InfosPros2-tabs2">
        <div className="item2-Infos2"onClick={() => navigate(`/desactiver-expert/${id}`)}>Informations</div>
        <div className="item2-Pros"onClick={() => navigate(`/projets-expert2/${id}`)}>Projets</div>
      </div>
