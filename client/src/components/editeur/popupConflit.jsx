      ...
      <div className="bg-white rounded-[20px] shadow-lg w-100 px-10 py-7 relative">
        ...
        <form onSubmit={handleSubmit}>
          ...
          rows={4}
            ...
            className="w-full text-justify main-text px-4 py-2 border border-neutral-300 rounded-xl text-neutral-500 resize-none focus:outline-none focus:ring-1 focus:ring-brown "
          />
