...
const PopLink = ({ initialUrl, onClose, onSubmit }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black/60 flex items-center justify-center z-[1001]">
      <div className="bg-white rounded-[20px] shadow-lg w-100 px-10 py-7  relative">
        {/* Close Button */}
        <button
        ...
        {/* Popup Title */}
        <h2 className=" buttons text-black mb-5">Inserer Lien</h2>
        ...
        <form onSubmit={handleSubmit}>
          <input
            ...
            className="w-full main-text px-4 py-2 border border-neutral-300 rounded-xl text-neutral-500 focus:outline-none focus:ring-1 focus:ring-brown"
          />
