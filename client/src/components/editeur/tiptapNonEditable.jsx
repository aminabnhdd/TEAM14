...
export default function TiptapNonEditable({ setEditor,section,annotations,setAnnotations,user,projet,setAnnotVisible })  {
  ...
  return (
     <>
        ...
        <p className="buttons text-black ">Contenu</p>
         <AnnotationButton  editor={editor}  annotations={annotations} setAnnotations={setAnnotations} user={user} projet={projet} section={section}/>                     
