...
export default function RightSection(props){
    ...
    <div className="border border-neutral-400 ml-6 w-[33%] rounded-[10px] p-7">
        ...
        <Auteurs isChef={props.isChef} projet={props.projet} setProjet={props.setProjet} chef={props.chef} collaborateurs={props.collaborateurs} setCollaborateurs={props.setCollaborateurs}  />}
    </div>
    )
}